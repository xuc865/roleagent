        ...
        for _step in range(self.config.env.max_steps):
            ...
            if OmegaConf.select(self.config, "algorithm.role_agent.enable_wia", default=False):
                ...
                for i in range(batch_size):
                    ...
                    # original reward unchanged.  This prevents the early-training
                    # "reward halving" problem where predicate_multiplier(0)=0.5
                    # would systematically shrink all step rewards before the model
