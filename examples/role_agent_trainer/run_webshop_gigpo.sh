#!/usr/bin/env bash
# Role-Agent (WIA + AIW) on WebShop with GiGPO (same recipe as examples/gigpo_trainer/run_webshop.sh).
# Data defaults to /mnt; override with VERL_DATA_ROOT.
set -x
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='gigpo_role_wia_aiw_qwen2.5_1.5b' \
