"""
Self-contained script to generate 05_failure_mode_bar.svg
No external data files needed - all data is embedded.
"""
...
BIN_COUNTS = {
    "repetitive_search": [325, 561, 743, 898, 1021, 1103, 1174, 1224, 1257, 1288],
    "wrong_search_location": [145, 297, 417, 499, 553, 577, 591, 605, 609, 610],
    ...
    "exhaustive_search_failure": [15, 19, 28, 32, 39, 41, 42, 44, 44, 44],
    "action_format_error": [2, 6, 7, 7, 7, 7, 7, 7, 7, 7],
}

# --- Display config ---
FAILURE_MODES = [
    "repetitive_search", "wrong_search_location", "wrong_receptacle",
    "premature_give_up", "missing_precondition", "repeated_failed_action",
    "navigation_loop", "entity_confusion", "wrong_object_interaction",
    "exhaustive_search_failure", "action_format_error",
]

MODE_LABELS = {
    "repetitive_search": "Repetitive Search",
    "wrong_search_location": "Wrong Search Location",
    ...
    "exhaustive_search_failure": "Exhaustive Search Failure",
    "action_format_error": "Action Format Error",
}

# Morandi color palette
MODE_COLORS = {
    "repetitive_search": "#D4897A",
    "wrong_search_location": "#E8B87A",
    ...
    "exhaustive_search_failure": "#D4A5A5",
...
def main():
    ...
    # Legend: 3 rows (ncol=4, 12 items / 4 = 3 rows)
    ax.legend(
        loc="upper center", bbox_to_anchor=(0.45, 1.32), fontsize=5,
        framealpha=0.95, edgecolor="#CCCCCC", fancybox=False,
        ncol=4, columnspacing=0.5, handlelength=1.0, handletextpad=0.3,
    ...
    output_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "failure_mode_plots", "05_failure_mode_bar.svg")
    os.makedirs(os.path.dirname(output_path), exist_ok=True)
    fig.savefig(output_path, bbox_inches="tight")
    plt.close(fig)
    print(f"[OK] Saved to: {os.path.abspath(output_path)}")
